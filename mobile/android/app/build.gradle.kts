...
android {
    namespace = "in.krishisaathi.krishi_saathi"
    ...
    defaultConfig {
        applicationId = "in.krishisaathi.krishi_saathi"
...
gradle.taskGraph.whenReady {
    if (allTasks.any { it.name.contains("Release") } && !keystoreFile.exists()) {
        throw GradleException("Release packaging requires android/key.properties and your private upload keystore. See mobile/README.md.")
    }
}
